...
describe('resolveRange', () => {
  it('resolves today range with compare window', () => {
    const now = new Date('2024-01-15T10:00:00Z');
    const range = resolveRange('today', now, tz);
  ...
  it('resolves last 7 days ending yesterday', () => {
    const now = new Date('2024-01-15T10:00:00Z');
    const range = resolveRange('7d', now, tz);
  ...
  it('resolves month-to-date range to yesterday', () => {
    const now = new Date('2024-06-05T12:00:00Z');
    const range = resolveRange('mtd', now, tz);
  ...
  it('resolves quarter-to-date range across DST', () => {
    const now = new Date('2024-05-15T08:00:00Z');
    const range = resolveRange('qtd', now, tz);
  ...
  it('resolves year-to-date range', () => {
    const now = new Date('2024-10-10T10:00:00Z');
    const range = resolveRange('ytd', now, tz);
  ...
  it('resolves custom range and compare', () => {
    const now = new Date('2024-03-10T12:00:00Z');
    const range = resolveRange({ kind: 'custom', start: '2024-03-02', end: '2024-03-05' }, now, tz);
  ...
  it('returns null for invalid custom ranges', () => {
    const now = new Date('2024-03-10T12:00:00Z');
    const range = resolveRange({ kind: 'custom', start: '2024-03-05', end: '2024-03-05' }, now, tz);
