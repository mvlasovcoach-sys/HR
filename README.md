...
## Overview
Static prototype for the SPA2099 HR Health experience, focused on leadership wellness dashboards backed by a mock biometric stream.
...
2. From the project root, start a local server:
   ...
   ```
3. Open `http://localhost:8000/Corporate.html` (or `User.html`) in your browser.
